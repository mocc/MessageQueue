...
public interface PersistenceManager {
    ...
    /**
     * add for MQ sematics Get the seqId of the last message that has been sent
     * to the queue receivers. The returned seqId will be set as the consume
     * position of any brand new subscription on this topic.
     * 
     * @param topic
     * @return
     * @throws ServerNotResponsibleForTopicException
